...
public class EntityTimeController extends TragicBoss {
	...
	public void onDeath(DamageSource par1DamageSource)
	{
		...
		if (!this.worldObj.isRemote && TragicNewConfig.allowMobStatueDrops && rand.nextInt(100) <= TragicNewConfig.mobStatueDropChance) this.entityDropItem(new ItemStack(TragicItems.MobStatue, 1, 3), 0.4F);
	}
