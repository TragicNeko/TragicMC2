...
public class EntityDropHelper {
	...
	public static ItemStack getRareDropFromEntity(Class clazz)
	{
		...
		try
		{
			ItemStack[] array = getRareLootArrayFromEntity(clazz);
			ItemStack stack = array[rand.nextInt(array.length)];
			return stack != null ? stack.copy() : null;
		}
		catch(Exception e)
		{
			TragicMC.logError("Error while retriving an entity's loot drops", e);
			return null;
		}
	}
	...
	public static ItemStack getCommonDropFromEntity(Class clazz)
	{
		...
		try
		{
			ItemStack[] array = getLootArrayFromEntity(clazz);
			ItemStack stack = array[rand.nextInt(array.length)];
			return stack != null ? stack.copy() : null;
		}
		catch(Exception e)
