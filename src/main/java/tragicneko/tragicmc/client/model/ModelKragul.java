...
public class ModelKragul extends ModelBase
{
	ModelRenderer Body;
	ModelRenderer Top;
	...
	public ModelKragul()
	{
		...
		RightHorn = new ModelRenderer(this, 16, 4);
		RightHorn.addBox(-2F, -3F, 0F, 1, 2, 1);
		RightHorn.setRotationPoint(0F, 13F, 0F);
		RightHorn.setTextureSize(64, 32);
		RightHorn.mirror = true;
		setRotation(RightHorn, 0F, 0F, 0F);
		LeftHorn = new ModelRenderer(this, 16, 4);
		LeftHorn.addBox(1F, -3F, 0F, 1, 2, 1);
		LeftHorn.setRotationPoint(0F, 13F, 0F);
