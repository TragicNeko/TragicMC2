...
public class SchematicCelestialTemple extends Schematic {
	...
	{
		Map<Integer, int[]> map = WorldHelper.getBlocksInSphericalRange(world, 14.0D, x + 4, y - 1, z + 4);
		int[] coords;
		...
		world.setBlock(x + 2, y, z, brick, 3, 2);
		...
		world.setBlock(x + 2, y, z + 9, brick, 3, 2);
		...
		world.setBlock(x + 3, y, z, brick, 3, 2);
		...
		world.setBlock(x + 3, y, z + 9, brick, 3, 2);
		...
		world.setBlock(x + 5, y, z, brick, 3, 2);
		...
		world.setBlock(x + 5, y, z + 9, brick, 3, 2);
		...
		world.setBlock(x + 6, y, z, brick, 3, 2);
		...
		world.setBlock(x + 6, y, z + 9, brick, 3, 2);
		...
		world.setBlock(x + 7, y, z, brick, 3, 2);
		...
		world.setBlock(x + 7, y, z + 9, brick, 3, 2);
